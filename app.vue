  ...
  >
    <div class="mt-25 flex w-full max-w-[40em] items-center justify-center lg:mt-34">
      ...
      >
        ...
        >
          <img alt="Nuxt logo" src="/nuxt.svg" class="h-14 w-14" width="{56}" height="{56}" />
        </div>
      </div>
      <div
          ...
          <div class="flex flex-col border-r border-[#EDEDF0]">
            ...
            <div class="grid grid-cols-2 gap-4 p-4">
              <div class="flex flex-col">
                ...
                <span class="truncate">{{ appwriteEndpoint }}</span>
              </div>
              <div class="flex flex-col">
                <span class="text-[#97979B]">Project-ID</span>
                <span class="truncate">{{ appwriteProjectId }}</span>
              </div>
              <div class="flex flex-col">
                <span class="text-[#97979B]">Project name</span>
                <span class="truncate">{{ appwriteProjectName }}</span>
              </div>
            </div>
          </div>
          <div class="flex-grow">
